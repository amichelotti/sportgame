...
function playerScoreSort() {
    ...
    for (var k in players) {
        ...
        list.push({ player: players[k].player, score: players[k].score, max: players[k].max, avg: players[k].avg, id: players[k].id });
    }
        ...
        try {
            ...
            if (data.hasOwnProperty("device") && (data.hasOwnProperty("cmd"))) {
                ...
                if (data['cmd'] == "request_to_join") {
                    if (!players.hasOwnProperty(data['device'])&&(game_started==false)) {
                        ...
                        if(game_started){
                            console.log("GAME IS RUNNING, Player " + data['player_list'] + " ");
                    ...
                    if (players.hasOwnProperty(data['device'])) {
                        ...
                        players[data['device']]['avg'] = data['avg'];
                        players[data['device']]['max'] = data['max'];
